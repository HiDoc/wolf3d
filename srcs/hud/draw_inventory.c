...
/*   Updated: 2019/04/10 15:33:48 by sgalasso         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void		fill_wpn(t_env *env, int iter)
{
	...
	{
		fill = (t_bloc){bloc->cross, bloc->use,
		NULL, NULL, NULL, bloc->cross.rect, {{0, 0}, {0, 0}}};
...
static void		fill_gems(t_env *env, int iter)
{
	...
	fill = (t_bloc){bloc->cross, bloc->use, NULL, NULL, NULL, rect,
	{{0, 0}, {0, 0}}};
