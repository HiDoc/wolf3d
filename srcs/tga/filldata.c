...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/03/27 19:49:05 by jsauron           #+#    #+#             */
/*   Updated: 2019/03/27 19:49:07 by jsauron          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	bpp24(unsigned char *base, unsigned char *tofill,
		int index, int index2)
{
	tofill[index2] = 255;
	tofill[index2 + 1] = base[index + 2];
...
static void	bpp16(unsigned char *base, unsigned char *tofill,
		int index, int index2)
{
